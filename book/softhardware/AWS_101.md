...
# Pull the image. This will pull the Docker image named seis_cloud from the GitHub Container Registry,
# with the specific tag f041ec0.
sudo docker pull ghcr.io/seisscoped/seis_cloud:f041ec0
# run the docker. This will run the seis_cloud image in interactive mode, and forward port 8888 from the container to port 8888 on the EC2 instance. 
# The latest tag will pull the most recent version of the image.
